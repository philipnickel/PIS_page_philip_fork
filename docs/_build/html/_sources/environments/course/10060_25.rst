...
10060 Physics - 2025 Spring & Autumn
--------------------------------------------------------------------------
...
.. card:: Install course environment steps
    ...
    #.
        ...
        (Or download the environment file :download:`here <https://pythonsupport.dtu.dk/_static/environments/10060_25.yml>`).

        .. code-block:: bash

            conda env create -n 10060_25 -f "https://pythonsupport.dtu.dk/_static/environments/10060_25.yml"

    #.
        When the above command has finished, a new Conda environment named ``10060_25``
...
.. dropdown:: Activate in VS Code
        ...
        3. Choose the option similar to ``Python 3.x.x ('10060_25')``.
...
.. dropdown:: Activate in Jupyter Notebook (VS Code)
    ...
    You can select the course environment by going to the upper right corner, clicking :menuselection:`Select Kernel`, and then choose ``10060_25 (Python 3.x.x)``.
