...
01002 Mathematics 1b - 2026 Spring
--------------------------------------------------------------------------
...
.. card:: Install course environment steps
    ...
    #.
        ...
        (Or download the environment file :download:`here <https://pythonsupport.dtu.dk/_static/environments/01002_S26.yml>`).

        .. code-block:: bash

            conda env create -n 01002_S26 -f "https://pythonsupport.dtu.dk/_static/environments/01002_S26.yml"

    #.
        When the above command has finished, a new Conda environment named ``01002_S26``
...
.. dropdown:: Activate in VS Code
        ...
        3. Choose the option similar to ``Python 3.x.x ('01002_S26')``.
...
.. dropdown:: Activate in Jupyter Notebook (VS Code)
    ...
    You can select the course environment by going to the upper right corner, clicking :menuselection:`Select Kernel`, and then choose ``01002_S26 (Python 3.x.x)``.
