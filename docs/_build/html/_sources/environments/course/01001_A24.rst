...
01001 Mathematics 1a - 2024 Autumn
--------------------------------------------------------------------------

In order to install Python requirements for ``01001 Mathematics 1a`` do the following steps.
...
.. card:: Install course environment steps
    ...
    #.
        ...
        (Or download the environment file :download:`here <https://pythonsupport.dtu.dk/_static/environments/01001_A24.yml>`).

        .. code-block:: bash

            conda env create -n 01001_A24 -f "https://pythonsupport.dtu.dk/_static/environments/01001_A24.yml"

    #.
        When the above command has finished, a new Conda environment named ``01001_A24``
...
.. dropdown:: Activate in VS Code
        ...
        3. Choose the option similar to ``Python 3.x.x ('01001_A24')``.
...
.. dropdown:: Activate in Jupyter Notebook (VS Code)
    ...
    You can select the course environment by going to the upper right corner, clicking :menuselection:`Select Kernel`, and then choose ``01001_A24 (Python 3.x.x)``.
