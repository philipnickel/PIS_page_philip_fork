...
.. card:: Install course environment steps
    ...
    #.
        ...
        (Or download the environment file :download:`here <https://pythonsupport.dtu.dk/_static/environments/02402_A25.yml>`).

        .. code-block:: bash

            conda env create -n 02402_A25 -f "https://pythonsupport.dtu.dk/_static/environments/02402_A25.yml"

    #.
        When the above command has finished, a new Conda environment named ``02402_A25``
...
.. dropdown:: Activate in VS Code
        ...
        3. Choose the option similar to ``Python 3.x.x ('02402_A25')``.
...
.. dropdown:: Activate in Jupyter Notebook (VS Code)
    ...
    You can select the course environment by going to the upper right corner, clicking :menuselection:`Select Kernel`, and then choose ``02402_A25 (Python 3.x.x)``.
